...
res <- lapply(samples,function(sample){
  args <- character(5)
  args[1] <- paste0("/mnt/ssd/ssd_1/workspace/vojta/val_editing/input_files/mapped/",sample,".bam")
  args[2] <- "/mnt/nfs/shared/CFBioinformatics/references_backup/mus_musculus/GRCm38.p6-93/annot/GRCm38.p6-93.gtf"
  args[3] <- "/mnt/nfs/shared/CFBioinformatics/references_backup/mus_musculus/GRCm38.p6-93/other/known_editing_sites/GRCm38.p6-93.csv"
  args[4] <- "/mnt/nfs/shared/CFBioinformatics/references_backup/mus_musculus/GRCm38.p6-93/other/snp/GRCm38.p6-93.all_snp.tsv"
  args[5] <- paste0("/mnt/ssd/ssd_1/workspace/vojta/val_editing/RNA_editing_analysis/",sample)
